...
namespace IdentityOAuthSpaExtensions.Wrappers
{
    internal static class ReflectionHelpers
    {
        ...
        )
        {
            ...
            IOptionsMonitor<RemoteAuthenticationOptions> optionsMonitor =
                property.GetValue(
                    authenticationHandler,
                    ...
                    new object[] {  },
                    CultureInfo.CurrentCulture
                ) as IOptionsMonitor<RemoteAuthenticationOptions>;
        ...
        )
        {
            ...
            while (type != null && !type.FullName.StartsWith(baseType))
                type = type.BaseType;
